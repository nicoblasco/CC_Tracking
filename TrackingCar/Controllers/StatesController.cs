...
namespace TrackingCar.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StateID,Descripcion,CountryID")] State state)
        {
            ...
            ViewBag.CountryID = new SelectList(db.Countries, "CountryID", "Descripcion", state.CountryID);
            return View(state);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StateID,Descripcion,CountryID")] State state)
        {
            if (ModelState.IsValid)
            {
